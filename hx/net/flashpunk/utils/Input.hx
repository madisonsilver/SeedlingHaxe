...
class Input
{
    ...
    /** @private */private static var _key : Array<Bool> = new Array<Bool>();
    /** @private */private static var _keyNum : Int = 0;
    /** @private */private static var _press : Array<Int> = new Array<Int>();
    /** @private */private static var _release : Array<Int> = new Array<Int>();
    /** @private */private static var _pressNum : Int = 0;
    /** @private */private static var _releaseNum : Int = 0;
    /** @private */private static var _control : Dynamic = { };
