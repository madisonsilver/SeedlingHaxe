...
class Tile extends Entity
{
    ...
    private static var types : Array<Dynamic> = ["Tile", "Tile", "Solid", "Tile", "Tile", "Tile", "Tile", "Tile", "Tile", "Solid", 
    ...
    override public function render() : Void
    {
        ...
        switch (t)
        {
            ...
            case 24:
                ...
                drawMyEdges();
            case 25:
                Game.sprWaterfall.frame = (Game.worldFrame(waterfallFrames, 0.8) + Math.floor(randVal * waterfallFrames)) % waterfallFrames + waterfallFrames * as3hx.Compat.parseInt(continuous);
            ...
            case 26:
                ...
                loops = 1;
                Game.sprBody.frame = bodyFrames[(Game.worldFrame(bodyFrames.length, loops) + as3hx.Compat.parseInt(randVal * bodyFrames.length)) % bodyFrames.length];
            ...
            case 27:
                ...
                loops = 2;
                Game.sprBodyWall.frame = bodyFrames[(Game.worldFrame(bodyFrames.length, loops) + as3hx.Compat.parseInt(randVal * bodyFrames.length)) % bodyFrames.length];
            ...
            case 29:
                ...
                {
                    bridgeOpeningTimer--;
                    Game.sprBridge.frame = openingBridge[as3hx.Compat.parseInt((1 - bridgeOpeningTimer / bridgeOpeningTimerMax) * openingBridge.length)];
