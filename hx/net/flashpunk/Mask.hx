...
class Mask
{
    ...
    // Mask information.
    /** @private */private var _class : Class<Dynamic>;
    /** @private */private var _check : Dictionary<Class<Dynamic>, (Dynamic)->Bool> = new Dictionary();
}
