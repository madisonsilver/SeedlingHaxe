...
{                
    ...
    private function updateFPSRead() : Void
    {
        ...
        _fpsInfoText0.text =
                "Update: " + Std.string(FP._updateTime) + "ms\n" +
                "Render: " + Std.string(FP._renderTime) + "ms";
        _fpsInfoText1.text =
                "Game: " + Std.string(FP._gameTime) + "ms\n" +
    ...
    // Find out the screen size and set the text.
    {
        ...
        var s : String = 
        "Mouse: " + Std.string(FP.world.mouseX) + ", " + Std.string(FP.world.mouseY) +
        "\nCamera: " + Std.string(FP.camera.x) + ", " + Std.string(FP.camera.y);
        if (SELECT_LIST.length != 0)
        {
    ...
    /** @private */private var _logHeight : Int;
    ...
    /** @private */private var _debWidth : Int;
    ...
    // Log information.
    /** @private */private var _logLines : Int = 33;
    /** @private */private var LOG(default, never) : Array<String> = new Array<String>();
    
    // Entity lists.
    /** @private */private var ENTITY_LIST(default, never) : Array<Entity> = new Array<Entity>();
    /** @private */private var SCREEN_LIST(default, never) : Array<Entity> = new Array<Entity>();
    /** @private */private var SELECT_LIST(default, never) : Array<Entity> = new Array<Entity>();
    
    // Watch information.
    /** @private */private var WATCH_LIST(default, never) : Array<String> = ["x", "y"];
