...
class CubicMotion extends Motion
{
    ...
    /**
		 ...
		 */
    public function setMotion(fromX : Float, fromY : Float, aX : Float, aY : Float, bX : Float, bY : Float, toX : Float, toY : Float, duration : Float, ease : Function = null) : Void
    {
        x = _fromX = fromX;
        y = _fromY = fromY;
        _aX = aX;
    ...
    /** @private */private var _ttt : Float;
    /** @private */private var _tt : Float;
}
