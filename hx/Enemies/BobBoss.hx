...
{
    @:meta(Embed(source="../../assets/graphics/BobBoss1.png"))
private static var imgBobBoss1 : Class<Dynamic>;
    @:meta(Embed(source="../../assets/graphics/BobBoss2.png"))
private static var imgBobBoss2 : Class<Dynamic>;
    @:meta(Embed(source="../../assets/graphics/BobBoss3.png"))
private static var imgBobBoss3 : Class<Dynamic>;
...
private var imgBobBossWeapons : Class<Dynamic>;
    ...
    private var text(default, never) : Array<Dynamic> = ["..., ...?~...~...!", "...never...~ages...~...seen...~...odd.~...for...minutes?~seconds...hours...~mine!", "Time is stasis.~You bring much conflict.~Is it my place to resist?~Seems I must."];
    ...
    override public function death() : Void
    {
        if (destroy)
        {
            ...
            if (nextBossTimer > 0)
            {
                ...
                {
                    (try cast(player.graphic, Image) catch(e:Dynamic) null).alpha = (nextBossTimer - nextBossTimerMax / 3) / (nextBossTimerMax - nextBossTimerMax / 3);
                }
